...
export const addInspectionSuccess = createAction(InspectionActions.ADD_INSPCETION_SUCCESS);

export const addInspectionTemplate = createAction(InspectionActions.ADD_INSPCETION_TEMPLATE);
export const addInspectionTemplateSuccess = createAction(InspectionActions.ADD_INSPCETION_TEMPLATE_SUCCESS);

export const getTemplateList = createAction(InspectionActions.GET_TEMPLATE_LIST);
export const getTemplateListSuccess = createAction(InspectionActions.GET_TEMPLATE_LIST_SUCCESS);

export const removeTemplate = createAction(InspectionActions.REMOVE_TEMPLATE);
export const removeTemplateSuccess = createAction(InspectionActions.REMOVE_TEMPLATE_SUCCESS);

export const addMessageTemplate = createAction(InspectionActions.ADD_MESSAGE_TEMPLATE);
export const addMessageTemplateSuccess = createAction(InspectionActions.ADD_MESSAGE_TEMPLATE_SUCCESS);

export const getMessageTemplate = createAction(InspectionActions.GET_MESSAGE_TEMPLATE);
export const getMessageTemplateSuccess = createAction(InspectionActions.GET_MESSAGE_TEMPLATE_LIST_SUCCESS);

export const updateMessageTemplate = createAction(InspectionActions.UPDATE_MESSAGE_TEMPLATE);
export const updateMessageTemplateSuccess = createAction(InspectionActions.UPDATE_MESSAGE_TEMPLATE_SUCCESS);

export const deleteMessageTemplate = createAction(InspectionActions.DELETE_MESSAGE_TEMPLATE);
export const deleteMessageTemplateSuccess = createAction(InspectionActions.DELETE_MESSAGE_TEMPLATE_SUCCESS);
