...
class HomePageComponent extends Component {
   constructor(props) {
      ...
      this.state = {
         ...
         errors: { title: null, section1: [], section2: [], section3: [] },
      }
   }
   ...
   validateYouTubeUrl = (url) => {
      ...
      if (url !== undefined || url !== '') {
         ...
         if (match && match[2].length === 11) {
            ...
            result = ('https://www.youtube.com/embed/' + match[2] + '?autoplay=1&enablejsapi=1');
         }
      }
      return result
   };
                                    ...
                                    <div class="col-sm-8">
                                       <div class="content-wrap text-right">
                                          <div class="main-heading-wrap">
                                             ...
                                             <h2>Work is Like Playing <span class="heading-highlighter">Game</span> </h2>
                                          </div>
                                 ...
                                 <div class="row align-items-center pt-3">
                                    ...
                                    <div class="col-sm-8">
                                       <div class="content-wrap text-left">
                                          <div class="main-heading-wrap">
                                             <p>Built-In Communication Tools</p>
                                             <h2>Provide World-Class Customer <span class="heading-highlighter">Services</span> </h2>
                                          </div>
